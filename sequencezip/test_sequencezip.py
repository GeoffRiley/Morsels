...
class SequenceZipTests(unittest.TestCase):
    ...
    def test_sequence_not_copied(self):
        ...
        self.assertEqual(seq2[-1], (99999,) * 100)
    ...
    def test_equality(self):
        ...
        seq4 = SequenceZip([1], [4, 6, 6], [7, 8, 9])
        seq5 = SequenceZip([1, 2, 3], [4, 5, 7], [7, 8, 9, 0])
        self.assertNotEqual(seq4, seq5)
        self.assertNotEqual(seq5, seq4)
