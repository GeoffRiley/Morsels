...
class ComparatorTests(unittest.TestCase):
    ...
    def test_comparing_comparator_objects(self):
        self.assertEqual(Comparator(5), Comparator(5.00000001))

    def test_greatest_delta_used_when_comparing_comparators(self):
        self.assertEqual(Comparator(5, delta=0.01), Comparator(5.1, delta=0.1))
        self.assertEqual(Comparator(5, delta=0.1), Comparator(5.1, delta=0.01))
